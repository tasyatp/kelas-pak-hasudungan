...
$query_login = "SELECT * FROM tamu";
$login = mysql_query($query_login, $hotel) or die(mysql_error());
...
<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
  <table width="360" height="80" align="center">
    <tr>
      ...
      <td width="96" height="23" style="color: #FFFFFF">Id_tamu</td>
...
<p align="center" class="T">Belum punya akun?silahkan <a href="register.php">register</a> terlebih dahulu!</p>
<p align="center" class="T"><a href="index.php"><img src="file:///C|/Users/PC/Downloads/download-removebg-preview (3).png" width="25" height="27" /></a></p>
</body>
</html>
<?php

...
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a class="MenuBarItemSubmenu" href="#">MENU</a>
    <ul>
      <li><a href="reservasitampil.php">pengecekan data reservasi</a></li>
      <li><a href="#">tgl checkin</a></li>
      <li><a href="reservasicari.php">Mencari data reservasi</a></li>
    </ul>
  </li>

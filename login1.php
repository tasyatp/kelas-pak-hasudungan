...
$query_login1 = "SELECT * FROM `admin`";
$login1 = mysql_query($query_login1, $hotel) or die(mysql_error());
$row_login1 = mysql_fetch_assoc($login1);
$totalRows_login1 = mysql_num_rows($login1);
?>
<?php
...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginFailed = "logingaga1l.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_hotel, $hotel);
  
  $LoginRS__query=sprintf("SELECT id_tamu, password FROM tamu WHERE id_tamu=%s AND password=%s",
...
<form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
  <table width="360" height="80" align="center">
    <tr>
      ...
      <td width="96" height="23" style="color: #FFFFFF">Id_admin</td>
...
<p align="center" class="T"><a href="index.php"><img src="file:///C|/Users/PC/Downloads/download-removebg-preview (3).png" width="27" height="25" /></a></p>
</body>
</html>
<?php
mysql_free_result($login1);
?>
